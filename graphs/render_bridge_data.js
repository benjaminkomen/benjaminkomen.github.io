/* Name:			render_bridge_data
 * Date: 			
 * Last modified:	March 29, 2016
 * Description:		Make 8 graphs of experiment data near bridge
 */
$(document).ready(function() {
	...
	//if not, show the 8 graphs of the experiment
		...
		var data_base_folder = 'http://homepage.tudelft.nl/u04r0/thesis/experiment-data/bridge/';
		$("h2#title").html('Kuilenburgse spoorbrug measurements March 24, 2016; bridge parts only');
		var data_files = [];
		var graph_name = [];
		for (i=1;i<9;i++) {
		...
		//start and end time
		var start_time = [17.19,28.18,25.07,28.48,39.14,10.99,31.89,5.75];
